...
return {
    on_enter = function(self, state_context)
        ...
        if self.entry_time <= 5 then
            ...
            crossplot:publish("empty", "empty") --These (1 / 2) are here on purpose; without them, crossplot won't pick up CONQUER_NZOTH when playing as NR. ~Mord
            crossplot:publish("empty", "empty") --These (2 / 2) are here on purpose; without them, crossplot won't pick up CONQUER_NZOTH when playing as NR. ~Mord
