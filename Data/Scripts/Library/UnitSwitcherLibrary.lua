...
function Get_Swap_Entry(upgrade_object)
	local swaps = {
		...
		["THALASSAUPGRADE"] = {"Thalassa","Night_Hammer_Delvardus"},
		["BRILLIANTUPGRADE"] = {"Delvardus_Brilliant","Night_Hammer_Delvardus"}, 
		["BRILLIANTUPGRADEEARLY"] = {"Delvardus_Brilliant","Thalassa"}, 
		["KAINEUPGRADE"] = {"Ardus_Kaine","Reaper_Kaine"},
		["IRONFISTUPGRADE"] = {"Iron_Fist_VSD","Iron_Fist"},
		["ISARDUPGRADE"] = {"Ysanne_Isard","Lusankya"},
		["DAALAUPGRADE"] = {"Gorgon","Daala_Knight_Hammer"},
		["PELLAEONUPGRADE"] = {"Chimera_Pellaeon_Grand","Pellaeon_Reaper"},
		["PELLAEONUPGRADE2"] = {"Chimera_Pellaeon_Grand","Pellaeon_Megador"},
		["ROGRISSUPGRADE"] = {"Agonizer_Star_Destroyer","Rogriss_Dominion"},
		...
		["DUMMY_RECRUIT_GROUP_RADAMA"] = {nil,{"Wellam_Eternal_Wrath", "Xantus_Team", "Ellor_Team"}},
		...
		["DUMMY_RECRUIT_GROUP_ARDA"] = {nil,{"Jocaos_Team", "Balrekk_Team", "Vorrel_Team"}},
