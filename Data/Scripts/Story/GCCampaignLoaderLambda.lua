...
function Definitions()
	...
	crossplot:galactic()
	crossplot:subscribe("LAMBDA_START_OPTION", Load_GC)
...
function Initialize(message)
    if message == OnEnter then	
		crossplot:publish("POPUPEVENT", "LAMBDA_START", {"LANKIN", "PANAKA"}, { },
				{ }, { },
				{ }, { },
				{ }, { },
				"LAMBDA_START_OPTION")
...
function Load_GC(choice)
	...
	local campaign_name = "Sandbox_LambdaSector"
	if choice == "LAMBDA_START_PANAKA" then
		campaign_name = campaign_name .. "Naboo"
	end
